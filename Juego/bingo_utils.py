...
def verificar_patron_ganador(carton, numeros_marcados, modo_juego):
    ...
    elif modo_norm == "doble_diagonal" or modo_norm == "doble diagonal":
        diagonal_principal = [0, 6, 12, 18, 24]
        diagonal_secundaria = [4, 8, 12, 16, 20]
        return all(carton_marcado[i] for i in diagonal_principal) and all(carton_marcado[i] for i in diagonal_secundaria)
